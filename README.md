...
* Since a majority of users have tracking preferences for activity (steps, distance traveled intensity of activity, and calories burned) and sleep, marketing should focus on these tracking abilites on the smart watch Time.
